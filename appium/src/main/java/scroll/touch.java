...
public class touch {
	...
	public static void tap(AndroidDriver driver) {
		...
		Dimension dimension = driver.manage().window().getSize();
		Point forTap = new Point((int)(dimension.width*0.5), (int)(dimension.height*0.));
   ...
   /* public static void tapcoedinate(PerformsTouchActions driver) {
    	TouchAction action = new TouchAction(driver);
    	action.tap(PointOption.point(578, 450)).release().perform();
    }
    public static void tapcoedinate1(PerformsTouchActions driver) {
    	TouchAction action = new TouchAction(driver);
    	action.tap(PointOption.point(75,203)).release().perform();
    } 
    public static void taocopyclipboard(PerformsTouchActions driver) {
    	TouchAction action = new TouchAction(driver);
    	action.tap(PointOption.point(994,203)).release().perform();
    } */
}
